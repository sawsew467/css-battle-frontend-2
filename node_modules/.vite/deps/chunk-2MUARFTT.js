...
function useCurrentColorScheme(options) {
  ...
  const setMode = React77.useCallback((mode) => {
  ...
  const setColorScheme = React77.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React77.useCallback((e) => {
  ...
  const mediaListener = React77.useRef(handleMediaQuery);
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React78.createContext(void 0);
  const useColorScheme = () => {
    const value = React78.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider({
    ...
    const hasMounted = React78.useRef(false);
    const upperTheme = useTheme4();
    const ctx = React78.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime50.jsxs)(React78.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime50.jsxs)(React78.Fragment, {
...
function joinChildren(children2, separator) {
  const childrenArray = React81.Children.toArray(children2).filter(Boolean);
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React90.useState(false);
...
var TouchRipple = React91.forwardRef(function TouchRipple2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiTouchRipple"
  });
  ...
  const [ripples, setRipples] = React91.useState([]);
  const nextKey = React91.useRef(0);
  const rippleCallback = React91.useRef(null);
  React91.useEffect(() => {
  ...
  const ignoringMouseDown = React91.useRef(false);
  const startTimer = React91.useRef(null);
  const startTimerCommit = React91.useRef(null);
  const container = React91.useRef(null);
  React91.useEffect(() => {
    return () => {
      clearTimeout(startTimer.current);
    };
  }, []);
  const startCommit = React91.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
    ...
    setRipples((oldRipples) => [...oldRipples, (0, import_jsx_runtime56.jsx)(TouchRippleRipple, {
      classes: {
  ...
  const start2 = React91.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  const pulsate = React91.useCallback(() => {
    start2({}, {
      pulsate: true
    });
  }, [start2]);
  const stop = React91.useCallback((event, cb) => {
    clearTimeout(startTimer.current);
  ...
  return (0, import_jsx_runtime56.jsx)(TouchRippleRoot, _extends({
    className: clsx_m_default(touchRippleClasses_default.root, classes.root, className),
    ref: container
  }, other, {
    children: (0, import_jsx_runtime56.jsx)(TransitionGroup_default, {
      component: null,
      exit: true,
      children: ripples
    })
...
var ButtonBase = React92.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  const rippleRef = React92.useRef(null);
  ...
  const keydownRef = React92.useRef(false);
  ...
  return (0, import_jsx_runtime58.jsxs)(ButtonBaseRoot, _extends({
    as: ComponentProp,
    className: clsx_m_default(classes.root, className),
    ownerState,
    onBlur: handleBlur2,
    ...
    children: [children2, enableTouchRipple ? (
      ...
      (0, import_jsx_runtime57.jsx)(TouchRipple_default, _extends({
        ref: handleRippleRef,
        center: centerRipple
      }, TouchRippleProps))
    ) : null]
...
var IconButton = React93.forwardRef(function IconButton2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiIconButton"
  });
  ...
  return (0, import_jsx_runtime59.jsx)(IconButtonRoot, _extends({
    className: clsx_m_default(classes.root, className),
    centerRipple: true,
...
true ? IconButton.propTypes = {
  ...
  children: chainPropTypes(import_prop_types53.default.node, (props) => {
    const found = React93.Children.toArray(props.children).some((child) => React93.isValidElement(child) && child.props.onClick);
    if (found) {
...
var SvgIcon = React94.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime61.jsxs)(SvgIconRoot, _extends({
    ...
    ownerState,
    children: [children2, titleAccess ? (0, import_jsx_runtime60.jsx)("title", {
...
var SuccessOutlined_default = createSvgIcon((0, import_jsx_runtime63.jsx)("path", {
...
var ReportProblemOutlined_default = createSvgIcon((0, import_jsx_runtime64.jsx)("path", {
...
var ErrorOutline_default = createSvgIcon((0, import_jsx_runtime65.jsx)("path", {
...
var InfoOutlined_default = createSvgIcon((0, import_jsx_runtime66.jsx)("path", {
...
var _excluded44 = ["action", "children", "className", "closeText", "color", "components", "componentsProps", "icon", "iconMapping", "onClose", "role", "severity", "slotProps", "slots", "variant"];
...
var defaultIconMapping = {
  success: (0, import_jsx_runtime68.jsx)(SuccessOutlined_default, {
    fontSize: "inherit"
  }),
  warning: (0, import_jsx_runtime68.jsx)(ReportProblemOutlined_default, {
    fontSize: "inherit"
  }),
  error: (0, import_jsx_runtime68.jsx)(ErrorOutline_default, {
    fontSize: "inherit"
  }),
  info: (0, import_jsx_runtime68.jsx)(InfoOutlined_default, {
    fontSize: "inherit"
  })
};
var Alert = React101.forwardRef(function Alert2(inProps, ref) {
  ...
  return (0, import_jsx_runtime69.jsxs)(AlertRoot, _extends({
    role,
    elevation: 0,
    ownerState,
    className: clsx_m_default(classes.root, className),
    ...
    children: [icon !== false ? (0, import_jsx_runtime68.jsx)(AlertIcon, {
      ownerState,
      className: classes.icon,
      children: icon || iconMapping[severity] || defaultIconMapping[severity]
    }) : null, (0, import_jsx_runtime68.jsx)(AlertMessage, {
      ownerState,
      className: classes.message,
      children: children2
    }), action != null ? (0, import_jsx_runtime68.jsx)(AlertAction, {
      ownerState,
      className: classes.action,
      children: action
    }) : null, action == null && onClose ? (0, import_jsx_runtime68.jsx)(AlertAction, {
      ownerState,
      className: classes.action,
      children: (0, import_jsx_runtime68.jsx)(AlertCloseButton, _extends({
        size: "small",
        ...
        children: (0, import_jsx_runtime68.jsx)(AlertCloseIcon, _extends({
          fontSize: "small"
        }, closeIconProps))
      }))
    }) : null]
...
true ? Alert.propTypes = {
   ...
   * [palette customization guide](https://mui.com/material-ui/customization/palette/#adding-new-colors).
   */
  color: import_prop_types55.default.oneOfType([import_prop_types55.default.oneOf(["error", "info", "success", "warning"]), import_prop_types55.default.string]),
  /**
  ...
  components: import_prop_types55.default.shape({
    CloseButton: import_prop_types55.default.elementType,
    CloseIcon: import_prop_types55.default.elementType
  }),
  /**
  ...
  componentsProps: import_prop_types55.default.shape({
    closeButton: import_prop_types55.default.object,
    closeIcon: import_prop_types55.default.object
  }),
  /**
   ...
   */
  iconMapping: import_prop_types55.default.shape({
    error: import_prop_types55.default.node,
    info: import_prop_types55.default.node,
    success: import_prop_types55.default.node,
    warning: import_prop_types55.default.node
  }),
  /**
   * Callback fired when the component requests to be closed.
   ...
   * @default 'success'
   */
  severity: import_prop_types55.default.oneOf(["error", "info", "success", "warning"]),
  /**
   * The extra props for the slot components.
   * You can override the existing props or add new ones.
   *
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2MUARFTT.js.map
